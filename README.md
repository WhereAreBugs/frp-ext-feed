...
This feed bundles packages built from the downstream FRP fork:
...
- `luci-app-frps-ext`: LuCI UI for `frps-ext`, sourced from https://github.com/WhereAreBugs/luci-app-frps-ext.git.
...
- LuCI packages are fetched from:
